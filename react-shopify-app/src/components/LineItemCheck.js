...
class LineItemCheck extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <li className="Line-item">
        <div className="Line-item__img">
          {this.props.line_item.variant.image ? <img src={this.props.line_item.variant.image.src} alt={`${this.props.line_item.title} product shot`} style={{borderRadius:'5px', border:'2px solid rgb(94, 93, 93)',width:'100%',height:'100%'}} /> : null}
        </div>
        <div className="Line-item__content">
          ...
          <div className="Line-item__content-row">
            ...
            ¥ { (this.props.line_item.quantity * this.props.line_item.variant.price).toFixed(0) }
            </span>
