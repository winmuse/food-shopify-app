        ...
        <li className="Line-item" style={{marginBottom:'1px'}}>
          ...
          <div className="Line-item__content">
            <div className="Line-item__content-row">
              <div className="Line-item__variant-title" style={{color:'#000',fontSize:'10px'}}>
                {props.line_item.variant.title}
              </div>
              <span className="Line-item__title" style={{color:'#000',fontSize:'10px'}}>
                {props.line_item.title}
              </span>
            </div>
            <div className="Line-item__content-row">
                <span className="Line-item__quantity1" style={{color:'#000',fontSize:'10px'}}>{props.line_item.quantity}</span>
              <span className="Line-item__price" style={{color:'#000',fontSize:'10px'}}>
